...
public class BPTrend{
    ...
    public String doCalc( String from, String to){
        ...
        for ( WeatherEntry x: collectedData){
            if ( (y1==null) && x.when.compareTo(d1) >= 0 ) { // now we are "inside" the doCalc region
                y1 = x;
                x1 = idx;
            }
            if (x.when.compareTo(d2) >= 0 ) { // now we are "outside" the doCalc region
                x2 = idx;
                y2 = x; 
                break;
            }
    ...
    public static void main(String[] args) {
        ...
        calcTrend.readData(basePath+"/Inspiration/Environmental_Data_Deep_Moor_2015.txt");
        ...
        from = "2015/01/01 00:30:00";
        to = "2015/01/01 02:30:00";

        System.out.println( calcTrend.doCalc( from, to ) );

        System.out.println("Test Case #2:");

        from = "2015/03/15 10:30:00";
        to = "2015/03/17 02:30:00";

        System.out.println( calcTrend.doCalc( from, to ) );

        System.out.println("Test Case #3:");

        from = "2015/05/21 10:00:00";
        to = "2015/05/25 23:59:59";

        System.out.println( calcTrend.doCalc( from, to ) );

        System.out.println("Test Case #4 Copenhagen today:");
        from = "2019/03/04 21:38:21";  // 2019/03/04 21:38:21
        to = "2019/03/05 09:22:00"; //2019/03/05 09:22:00
